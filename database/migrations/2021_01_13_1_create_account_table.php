...
class CreateAccountTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('account', function (Blueprint $table) {
            ...
            $table->string('acc_fullname', 100)->nullable()->comment('Tên đầy đủ # Tên đầy đủ của người dùng');
            $table->unsignedTinyInteger('acc_sex')->default('3')->comment('Giới tính # Giới tính: 0-Nữ, 1-Nam, 2-Khác');
            $table->dateTime('acc_birthday')->nullable()->comment('Ngày sinh # Ngày sinh');
