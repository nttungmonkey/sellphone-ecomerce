...
class ProductExport implements FromView, WithDrawings, WithEvents, ShouldAutoSize
{
    use Exportable, RegistersEventListeners;

    public function view(): View
    {
        return view('backend.products.excel', [
    ...
    public function drawings()
    {
        ...
        foreach($ds_sanpham as $index=>$sp)
        {
            ...
            $drawing->setDescription($sp->pro_descriptS);
