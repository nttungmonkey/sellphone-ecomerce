...
class ManufactureExport implements FromView, WithDrawings, WithEvents, ShouldAutoSize
{
    use Exportable, RegistersEventListeners;

    public function view(): View
    {
        return view('backend.manufactures.excel', [
    ...
    public function drawings()
    {
        ...
        $drawingLogo->setPath(public_path('storage\images\admin\logos\logo1.png'));
        ...
        foreach($manu as $index=>$sp)
        {
            $drawing = new \PhpOffice\PhpSpreadsheet\Worksheet\Drawing();
            $drawing->setName($sp->mnf_logo);
            $drawing->setDescription('Image');
            $drawing->setPath(public_path('storage/images/manufactures/'. $sp->mnf_logo));
